...
AC_DEFUN([ZFS_AC_KERNEL_TEST_SRC], [
	...
	ZFS_AC_KERNEL_SRC_PAGEMAP_READAHEAD_FOLIO
	ZFS_AC_KERNEL_SRC_PAGEMAP_FOLIO_WAIT_WRITEBACK
	...
	ZFS_AC_KERNEL_SRC_MM_STRUCT_FOLIO
	ZFS_AC_KERNEL_SRC_MM_MAPPING_SET_LARGE_FOLIOS
	ZFS_AC_KERNEL_SRC_FILE
	ZFS_AC_KERNEL_SRC_FILE_SETLEASE
	ZFS_AC_KERNEL_SRC_FILEATTR_OPS
	ZFS_AC_KERNEL_SRC_ALLOC_INODE_SB
	ZFS_AC_KERNEL_SRC_FS_CONTEXT
	ZFS_AC_KERNEL_SRC_FILE_MMAP_PREPARE
...
AC_DEFUN([ZFS_AC_KERNEL_TEST_RESULT], [
	...
	ZFS_AC_KERNEL_PAGEMAP_READAHEAD_FOLIO
	ZFS_AC_KERNEL_PAGEMAP_FOLIO_WAIT_WRITEBACK
	...
	ZFS_AC_KERNEL_MM_STRUCT_FOLIO
	ZFS_AC_KERNEL_MM_MAPPING_SET_LARGE_FOLIOS
	ZFS_AC_KERNEL_1ARG_ASSIGN_STR
	ZFS_AC_KERNEL_FILE
	ZFS_AC_KERNEL_FILE_SETLEASE
	ZFS_AC_KERNEL_FILEATTR_OPS
	ZFS_AC_KERNEL_ALLOC_INODE_SB
	ZFS_AC_KERNEL_FS_CONTEXT
	ZFS_AC_KERNEL_FILE_MMAP_PREPARE
