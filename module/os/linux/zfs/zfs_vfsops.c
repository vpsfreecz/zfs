...
static const match_table_t zpl_tokens = {
	...
	{ TOKEN_IGNORE,		MNTOPT_DEFAULTS },
	{ TOKEN_IGNORE,		MNTOPT_AUTO },
	{ TOKEN_IGNORE,		MNTOPT_NOAUTO },
	{ TOKEN_IGNORE,		MNTOPT_CONTEXT "=%s" },
	{ TOKEN_IGNORE,		MNTOPT_FSCONTEXT "=%s" },
	{ TOKEN_IGNORE,		MNTOPT_DEFCONTEXT "=%s" },
	{ TOKEN_IGNORE,		MNTOPT_ROOTCONTEXT "=%s" },
	{ TOKEN_IGNORE,		MNTOPT_DIRATIME },
	{ TOKEN_IGNORE,		MNTOPT_NODIRATIME },
	{ TOKEN_IGNORE,		MNTOPT_DIRSYNC },
	{ TOKEN_IGNORE,		MNTOPT_GROUP },
	{ TOKEN_IGNORE,		MNTOPT_IVERSION },
	{ TOKEN_IGNORE,		MNTOPT_NOIVERSION },
	{ TOKEN_IGNORE,		MNTOPT_OWNER },
	{ TOKEN_IGNORE,		MNTOPT_USER },
	{ TOKEN_IGNORE,		MNTOPT_USERS },
	{ TOKEN_IGNORE,		MNTOPT_NETDEV },
	{ TOKEN_IGNORE,		MNTOPT_NOFAIL },
	{ TOKEN_IGNORE,		MNTOPT_STRICTATIME },
	{ TOKEN_IGNORE,		MNTOPT_NOSTRICTATIME },
	{ TOKEN_IGNORE,		MNTOPT_LAZYTIME },
	{ TOKEN_IGNORE,		MNTOPT_SYNC },
	{ TOKEN_IGNORE,		MNTOPT_ASYNC },
	{ TOKEN_IGNORE,		MNTOPT_COMMENT },
	{ TOKEN_IGNORE,		MNTOPT_ZFSUTIL },
	{ TOKEN_IGNORE,		MNTOPT_ACL },
	{ TOKEN_IGNORE,		MNTOPT_NOACL },
	{ TOKEN_IGNORE,		MNTOPT_POSIXACL },
	{ TOKEN_IGNORE,		MNTOPT_SUB },
	{ TOKEN_IGNORE,		MNTOPT_NOSUB },
	{ TOKEN_IGNORE,		MNTOPT_QUIET },
	{ TOKEN_IGNORE,		MNTOPT_LOUD },
	{ TOKEN_IGNORE,		MNTOPT_BIND },
	{ TOKEN_IGNORE,		MNTOPT_RBIND },
	{ TOKEN_IGNORE,		MNTOPT_CASESENSITIVE },
	{ TOKEN_IGNORE,		MNTOPT_CASEINSENSITIVE },
	{ TOKEN_IGNORE,		MNTOPT_CASEMIXED },
	{ TOKEN_LAST,		NULL },
};
...
int
zfsvfs_apply_option(vfs_t *vfsp, zfsvfs_mntopt_t opt, const char *value)
{
	switch (opt) {
	case ZFS_MNTOPT_RO:
...
zfsvfs_parse_option(char *option, int token, substring_t *args, vfs_t *vfsp)
{
	...
	switch (token) {
	case TOKEN_RO:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_RO, NULL));
	case TOKEN_RW:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_RW, NULL));
	case TOKEN_SETUID:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_SETUID, NULL));
	case TOKEN_NOSETUID:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NOSETUID, NULL));
	case TOKEN_EXEC:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_EXEC, NULL));
	case TOKEN_NOEXEC:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NOEXEC, NULL));
	case TOKEN_DEVICES:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_DEVICES, NULL));
	case TOKEN_NODEVICES:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NODEVICES, NULL));
	case TOKEN_DIRXATTR:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_DIRXATTR, NULL));
	case TOKEN_SAXATTR:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_SAXATTR, NULL));
	case TOKEN_XATTR:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_XATTR, NULL));
	case TOKEN_NOXATTR:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NOXATTR, NULL));
	case TOKEN_ATIME:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_ATIME, NULL));
	case TOKEN_NOATIME:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NOATIME, NULL));
	case TOKEN_RELATIME:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_RELATIME, NULL));
	case TOKEN_NORELATIME:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NORELATIME, NULL));
	case TOKEN_NBMAND:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NBMAND, NULL));
	case TOKEN_NONBMAND:
		return (zfsvfs_apply_option(vfsp, ZFS_MNTOPT_NONBMAND, NULL));
	case TOKEN_MNTPOINT:
		if (args[0].from == NULL || args[0].to == NULL)
			return (SET_ERROR(EINVAL));
		term = *args[0].to;
		*args[0].to = '\0';
...
int
zfs_domount_vfs(struct super_block *sb, const char *osname, vfs_t *vfs,
    int silent)
{
...
zfs_domount(struct super_block *sb, zfs_mnt_t *zm, int silent)
{
	...
	ASSERT(zm);
	ASSERT(zm->mnt_osname);

	error = zfsvfs_parse_options(zm->mnt_data, &vfs);
	if (error)
		return (error);

	return (zfs_domount_vfs(sb, zm->mnt_osname, vfs, silent));
}
...
int
zfs_remount_vfs(struct super_block *sb, int *flags, vfs_t *vfsp)
{
	zfsvfs_t *zfsvfs = sb->s_fs_info;
...
zfs_remount(struct super_block *sb, int *flags, zfs_mnt_t *zm)
{
	...
	return (zfs_remount_vfs(sb, flags, vfsp));
}
